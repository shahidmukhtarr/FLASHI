          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ color: 'var(--text-secondary, #666)', lineHeight: 1.8, marginBottom: '1rem', fontSize: '1.05rem' }}>
                FLASHI was born from a simple frustration — spending hours jumping between websites trying to find the best price for a product, only to regret not having checked one more store. Manually checking each store wastes valuable time and money.
              </p>
              <p style={{ color: 'var(--text-secondary, #666)', lineHeight: 1.8, marginBottom: '1rem', fontSize: '1.05rem' }}>
              ...
              <p style={{ color: 'var(--text-secondary, #666)', lineHeight: 1.8, fontSize: '1.05rem' }}>
                We believe every Pakistani shopper deserves access to the best deals. Whether you're looking for the latest smartphones or want to understand market prices, FLASHI makes it effortless.
              </p>
            </div>
      ...
      <section style={{
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-secondary, #666)', marginBottom: '3rem', fontSize: '1.05rem' }}>
            We aggregate prices from Pakistan's most trusted online stores. Compare platforms instantly to find the best value.
          </p>
