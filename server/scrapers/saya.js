...
const STORE_NAME = 'Saya';
const STORE_URL = 'https://saya.pk';
const STORE_COLOR = '#c2185b';

const COLLECTION_URLS = [
  'https://saya.pk/collections/us-3-pcs-lawn-dupatta-437033304296',
  'https://saya.pk/collections/pret-2-pcs-s-t-437033402600',
  'https://saya.pk/collections/us-2-pcs-s-t-437033337064',
  'https://saya.pk/collections/us-3-pcs-others-dupatta-437033468136',
  'https://saya.pk/collections/pret-3-pcs-437197832424',
];
...
async function fetchCollectionProducts(collectionUrl, query, limit = 20) {
  try {
    ...
    const queryWords = query.toLowerCase().split(/\s+/).filter(w => w.length > 1 && w !== 'saya');
