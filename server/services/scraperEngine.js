...
function isRelevantProduct(title, query) {
  ...
  const SYNONYMS = {
    ...
    'phone': ['mobile', 'smartphone', 'cellphone', 'iphone', 'galaxy', 'redmi', 'infinix', 'tecno', 'vivo', 'oppo', 'realme', 'nokia', 'itel', 'oneplus', 'honor'],
    'mobile': ['phone', 'smartphone', 'cellphone', 'iphone', 'galaxy', 'redmi', 'infinix', 'tecno', 'vivo', 'oppo', 'realme', 'nokia', 'itel', 'oneplus', 'honor'],
    'monitor': ['display', 'screen'],
    'headphone': ['headset', 'earphone', 'earphones'],
    'earbuds': ['buds', 'earphones', 'pods', 'airpods', 'tws', 'earbud'],
    'earbud': ['buds', 'earphones', 'pods', 'airpods', 'tws', 'earbuds'],
    'keyboard': ['board'],
    ...
    'watch': ['wristwatch', 'watches', 'smartwatch'],
    'watches': ['watch', 'wristwatch', 'smartwatch'],
    'case': ['cases', 'cover', 'protector'],
